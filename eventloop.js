...
15. scheduleImmediate() method executed;
    22.1. setImmediate() is being executed in the Check phase of Event Loop;
    22.2. the console.log("Immediate task executed") method is moved to Macro-Task Queue immediately;
